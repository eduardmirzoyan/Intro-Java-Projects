...
public class TimeTest02 {
	...
	public static void testChoice() {
		Time t1 = new Time(520);
		Time t2 = new Time(0, 1440);
		Time t3 = new Time(0, 1440);
		Time t4 = new Time(22,45);
		Time t5 = new Time(8,30);

		System.out.println("Testing Choice Methods");
		System.out.println(t1.toMins() + " minutes to time is " + t1);
		System.out.println(t2 + " + " + t3 + " = " + t2.add(t3));
		System.out.println(t4 + " - " + t5 + " = " + t4.subtract(t5));
	}
